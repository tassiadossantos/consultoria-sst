...
export const settings = pgTable("settings", {
  ...
  token_expiration: integer("token_expiration"), // minutos
...
export const insertPgrRiskSchema = createInsertSchema(pgrRisks).omit({
  id: true,
  created_at: true,
}).extend({
...
export const insertPgrActionSchema = createInsertSchema(pgrActions).omit({
  id: true,
  created_at: true,
}).extend({
